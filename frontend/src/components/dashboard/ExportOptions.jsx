    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Excel-compatible spreadsheet format</p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Complete data with metadata</p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Formatted report for printing</p>
        </div>
      </div>
